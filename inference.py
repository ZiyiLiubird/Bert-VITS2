...
if __name__ == "__main__":
    ...
    text_output, audio_output = tts_fn(text="On the way here, I happened to learn of the bounty on your head. As expected, you seem to have given them quite the challenge in that regard.",
           speaker="Wanye",
           sdp_ratio=0.5,
           noise_scale=0.6,
           length_scale=1.1,
    ...
    print(text_output)
    print(len(audio_output))
    audio = audio_output[1]
